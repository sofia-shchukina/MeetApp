...
class IntegrationTest {
    ...
    void deleteParticipant() throws Exception {
        ...
        mockMvc.perform(delete("/participants/" + "123/" + "124").with(csrf()))
                .andExpect(status().is(204));

        mockMvc.perform(MockMvcRequestBuilders.get("/participants/123").with(csrf()))
    ...
    void deleteParticipantDoesNotExist() throws Exception {
        ...
        String id = "111";
        mockMvc.perform(MockMvcRequestBuilders.delete("/participants/123/" + id).with(csrf()))
                .andExpect(status().is(404));
    }
    ...
    void receiveCurrentRound() throws Exception {
        ...
        mockMvc.perform(get("/participants/pairs/123/currentRound"))
                .andExpect(status().isOk()).andExpect(content().json("""
                                         [
                                        [{"name":"Mike","id":"1","email":"1@gmail.com"},
                        {"name":"Mary","id":"2","email":"2@gmail.com"}],
